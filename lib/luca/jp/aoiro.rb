    ...
    class Aoiro < LucaBook::State
      ...
      def proc_version
        if @end_date >= Date.parse('2022-4-1')
          { 'proc' => '22.0.3', 'HOA112' => '4.0', 'HOA116' => '3.0', 'HOA420' => '21.0', 'HOA511' => '14.0', 'HOA522' => '8.0', 'HOK010' => '6.0' }
        elsif @end_date >= Date.parse('2021-4-1')
          { 'proc' => '21.0.2', 'HOA112' => '3.1', 'HOA116' => '2.0', 'HOA420' => '20.0', 'HOA511' => '13.0', 'HOA522' => '7.0', 'HOK010' => '6.0' }
        else
          { 'proc' => '20.0.2', 'HOA112' => '2.0', 'HOA116' => '1.0', 'HOA420' => '19.0', 'HOA511' => '13.0', 'HOA522' => '6.0', 'HOK010' => '5.0' }
        end
      end
